    ...
    return (
        <DefaultLayout>
            <Section style={{ padding: "16px 16px 0px 16px" }}>
                <Heading as="h2">Hi {name}, ⚡️</Heading>

                <Text>We're really excited to have you on board.</Text>

                <Text>
                    We need you to verify the email address you used in signing up. We'll be sending notifications, tips and updates to this email
                    address. Please click the button below to verify.
                </Text>
